...
export const MAX_FORMAT_FILES_OVERRIDES = config.max_format_files_overrides
...
export const GEMINI_PROMPT_OPTIONS = [
  {
    ...
    label:
      'Track speakers separately (Example: Split "S5: Is if they had a history... S2: Of vaccine" into two distinct speaker segments)',
  },
  {
    id: 2,
    title: 'Capitalize Abbreviations and First Letter',
    label:
      'Capitalize abbreviations and proper nouns (Example: Change "cdc" to "CDC", "mmr" to "MMR")',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    label:
      'Prevent speech overlap (Example: "0:21:32.34 S3: People perceive disability differently. To some people...", "0:21:32.34 S5: more than that." to some people shoudl belong the S5 speaker.)',
  },
  {
    id: 6,
    title: 'Use Appropriate Punctuation for Clarity',
    label:
      'Add proper punctuation (Example: "Is that correct?" instead of "Is that correct.")',
  },
  {
    id: 7,
    title: 'Fix Run-On Sentences',
    label:
      'Separate run-on sentences (Example: "People perceive disability differently. To some people" instead of "differently, to some people")',
  },
  {
    id: 8,
    title: 'Capture Objections and Interruptions',
    label:
      'Include clear objections (Example: Capture opposing attorney interruptions even during witness testimony)',
  },
  {
    id: 9,
