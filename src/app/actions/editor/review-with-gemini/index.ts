...
export async function geminiRequestAction(lastSegment: string, transcript: string, fileKey: string, chunkIndex: number, totalChunks: number, temperature: number, model: GeminiModel, clientPrompt?: string, ) {
