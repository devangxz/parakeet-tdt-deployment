...
const content = [
    ...
    Content: () => (
      <div id='intro'>
        <header className='mb-3 -mt-5'>
          <h2 className='text-black text-xl font-medium'>Welcome to Scribie</h2>
        </header>
        <article className='space-y-4'>
          ...
          <p className='text-slate-500'>
            ...
            <a className='text-blue-600 underline' href='/customer-guide#sample'>
              sample
            </a>
            ) using our reliable human-verified{' '}
            <a className='text-blue-600 underline' href='/customer-guide#transcription-process'>
              transcription process
            </a>
            , ensuring high accuracy. You can even check the transcript as it is being prepared. In case you require further revisions, we also offer{' '}
            <a
    ...
    Content: () => (
      <div className='pt-0' id='quick-start'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Quick Start</h3>
        </header>
        <article className='space-y-4'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='payments'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Payments</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    id: 'deliveries',
    Content: () => (
      <section id='manual-deliveries'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Delivery Policy</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
          ...
          <p className='text-slate-500'>
            <a href='/customer-guide#additional-charges' className='text-blue-600 underline'>
              Additional charges
            </a>{' '}
  ...
  },
  {
    ...
    Content: () => (
      <section id='refunds'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Refund Policy</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='cancellations'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Cancellations</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='editor'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Integrated Editor</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='confidentiality'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Confidentiality</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='accuracy'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Accuracy</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    id: 're-reviews',
    Content: () => (
      <section id='re-reviews'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Free Re-reviews</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='teams'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Teams</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
            ...
            YouTubers, or videographers.
          </p>
          <p className='text-slate-500'>
            To utilize this feature, you can navigate to the{' '}
            <a href='/settings/teams' className='text-blue-600 underline'>
              settings page
            </a>{' '}
          ...
          <p className='text-slate-500'>
            ...
            <a
              href='https://scribie.com/blog/2023/01/introducing-team-workspaces/'
              className='text-blue-600 underline'
            >
  ...
  },
  {
    id: 'folder-feature',
    Content: () => (
      <section id='folder-feature'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Folder Feature</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
          ...
          <p className='text-slate-500'>
            ...
            <a className='text-blue-600 underline' href='/files/all-files'>
              All Files
            </a>{' '}
          ...
          <p className='text-slate-500'>
            ...
            <a className='text-blue-600 underline' href='/files/upload'>
              Uploads
            </a>{' '}
  ...
  },
  {
    id: 'account-credits',
    Content: () => (
      <section id='account-credits'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Account Credits</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
          ...
          <p className='text-slate-500'>
            You can{' '}
            <a href='/settings/credits' className='text-blue-600 underline'>
              add credits
            </a>{' '}
  ...
  },
  {
    ...
    Content: () => (
      <section id='transcription-process'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Transcription Process</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='transcript-format'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Transcript Format</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    id: 'default-format',
    Content: () => (
      <section id='default-format'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>Default Format</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='custom-format'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>Custom Format</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='transcript-file-formats'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Transcript File Formats</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => {
      ...
      return (
        <section id='additional-charges'>
          <header className='mb-3'>
            <h3 className='text-black text-xl font-medium'>Additional Charges</h3>
          </header>
          <article className='space-y-4'>
            <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='accented-speakers'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>Accented Speakers</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    id: 'noisy-files',
    Content: () => (
      <section id='noisy-files'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>Noisy Files</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='recording-tips'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Recording Tips</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='best-practices'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>Best Practices</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='inperson-recordings'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>In-person Recordings</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='call-recordings'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>Phone/Online Call Recordings</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='recommended-readings'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>Recommended Readings</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
    ...
    Content: () => {
      ...
      return (
        <section id='order-options'>
          <header className='mb-3'>
            <h3 className='text-black text-xl font-medium'>Order Options</h3>
          </header>
          <article className='space-y-4'>
            <p className='text-slate-500'>
  ...
  },
  {
    id: 'strict-verbatim',
    Content: () => (
      <section id='strict-verbatim'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>Strict Verbatim</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    id: 'rush-orders',
    Content: () => (
      <section id='rush-orders'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>Rush Orders</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    id: 'subtitle-file',
    Content: () => (
      <section id='subtitle-file'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>Subtitle File</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
            ...
            if you require subtitle files in other formats. No additional
  ...
  },
  {
    id: 'audio-timecoding',
    Content: () => (
      <section id='audio-timecoding'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>Audio Timecoding</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    id: 'speaker-tracking',
    Content: () => (
      <section id='speaker-tracking'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>Speaker Tracking</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
            ...
            <a className='text-blue-600 underline' href='/customer-guide#editor'>
              Integrated Editor.
            </a>
          </p>
          <p className='text-slate-500'>
  ...
  },
  {
    id: 'spelling-style',
    Content: () => (
      <section id='spelling-style'>
        <header className='mb-3'>
          <h3 className='text-black text-lg'>Spelling Style</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => {
      ...
      return (
        <section id='transcript-template'>
          <header className='mb-3'>
            <h3 className='text-black text-lg'>Transcript Template</h3>
          </header>
          <article className='space-y-4'>
            <p className='text-slate-500'>
  ...
  },
  {
    id: 'closed-captions',
    Content: () => (
      <section id='closed-captions'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Closed Captions</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    ...
    Content: () => (
      <section id='unique-selling-points'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Unique Selling Points</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
  ...
  },
  {
    id: 'sample',
    Content: () => (
      <section id='sample-transcript'>
        <header className='mb-3'>
          <h3 className='text-black text-xl font-medium'>Sample Transcript</h3>
        </header>
        <article className='space-y-4'>
          <p className='text-slate-500'>
          ...
          <div className="flex flex-col space-y-4 mt-4">
            <div className="border rounded-md p-4 bg-slate-50">
              <h4 className="text-black font-medium mb-3">Sample Audio</h4>
              <audio controls className="w-full">
                <source src="/audio/sample_audio.mp3" type="audio/mpeg" />
                Your browser does not support the audio element.
              </audio>
            </div>
            
            <div className="border rounded-md p-4 bg-slate-50">
              <h4 className="text-black font-medium mb-3">Sample Transcript</h4>
              <a 
                href="https://drive.google.com/file/d/0B6jpRw-jmsWdQkl1YjlYeTczSzQ/view?resourcekey=0-Dv8FceUIt_cOJoLp9PqxCQ" 
                target="_blank" 
              ...
              >
                ...
                <span>View Sample Transcript (PDF)</span>
              </a>
              
              <div className="w-full h-[500px] border border-gray-200 rounded">
                <iframe 
                  src="https://drive.google.com/file/d/0B6jpRw-jmsWdQkl1YjlYeTczSzQ/preview?resourcekey=0-Dv8FceUIt_cOJoLp9PqxCQ" 
      ...
      <>
        ...
        return (
          <a
            ...
            className={`flex items-center gap-2.5 rounded-lg py-2 px-2 transition-all ${
    ...
    <>
      <div className='w-full min-h-screen'>
        <div className='flex flex-col lg:flex-row'>
          ...
          <nav className='hidden lg:flex lg:flex-col space-y-1 w-96 h-[calc(100vh-64px)] sticky top-[64px] pt-8 pb-4 pl-[10%] overflow-y-auto'>
            <SidebarContent />
          </nav>
