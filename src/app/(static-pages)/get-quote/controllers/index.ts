...
export const formSchema = z.object({
  ...
  strictVerbatim: z.boolean().optional(),
  accentedSpeakers: z.boolean().optional(),
  noisyAudio: z.boolean().optional(),
  srtVtt: z.boolean().optional(),
  customFormatting: z.boolean().optional(),
