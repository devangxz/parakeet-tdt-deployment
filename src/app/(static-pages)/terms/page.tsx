    ...
    <div className='w-[100%]'>
      ...
      <div className='space-y-[5rem] px-[10%] py-[5rem]'>
        <div className='space-y-[2rem]'>
          ...
          <p className='text-slate-400'>
            By using our Services, you are agreeing to these terms including any
            subsequent changes or modifications. Please read them carefully. If
            you do not agree to these Terms or our Privacy Policy, please do not
            use the Scribie.com website or any of our Services and products.
          </p>
          ...
          <ul className='text-slate-400 list-disc space-y-2 pl-[1rem]'>
            <li>
            ...
            <li>
              When you use the &quot;Remember Me&quot; feature of Scribie
          ...
          <p className=''>B. Collected Information</p>
          <p className='text-slate-400'>
        ...
        <div className='space-y-[1rem]'>
          <p className=''>2. Privacy & Copyright Protection</p>
          <p className='text-slate-400'>
          ...
          submitting notices and Scribie&apos;s policy about responding to
          notices in our Help Center.
        </div>

        <div className='space-y-[1rem]'>
          <p className=''>3. Derivative Products</p>
          <p className='text-slate-400'>
