...
export const metadata: Metadata = {
  title:
    'Scribie - Industry-Leading Transcription Services | Audio & Video to Text',
  icons: '/assets/images/logo.svg',
  description:
    "Scribie's transcription services turn your recordings into accurate text. From legal depositions to marketing focus groups, we provide precise transcripts in custom formats. Try our fast, reliable service today.",
  keywords:
