...
var getCreditBalance = function (userId, internalTeamUserId) { return __awaiter(void 0, void 0, void 0, function () {
    var customerId, invoices, creditsBalance, roundedCreditsBalance, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                customerId = internalTeamUserId || userId;
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
            ...
            case 2:
                ...
                console.info("Credit balance ".concat(creditsBalance, " for ").concat(customerId));
                return [2 /*return*/, {
                        success: true,
            ...
            case 3:
                err_1 = _a.sent();
                console.error('Error fetching credit balance:', err_1);
                return [2 /*return*/, {
                        success: false,
                        creditsBalance: 0,
                    }];
