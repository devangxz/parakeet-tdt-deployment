...
var getDefaultOptions = function (userId) { return __awaiter(void 0, void 0, void 0, function () {
    var defaultOptions, instructions, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                logger_1.default.info('--> getDefaultOptions');
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
            ...
            case 2:
                ...
                return [4 /*yield*/, prisma_1.default.defaultInstruction.findFirst({
                        where: { userId: userId },
            ...
            case 4:
                err_1 = _a.sent();
                logger_1.default.error("Error getting default options: ".concat(err_1));
                return [2 /*return*/, {
